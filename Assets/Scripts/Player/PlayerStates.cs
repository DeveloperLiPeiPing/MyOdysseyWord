...
{
	[CreateAssetMenu(fileName = "NewPlayerStates", menuName = "Player/New Player States")]
	public class PlayerStates : EntityStats<PlayerStates>
	{
		...
		[Header("Rail Grinding Dash States")]
